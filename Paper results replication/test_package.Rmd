...
quantile_res_75_quantile <-apply(sim_reserve_12_40_mat, MARGIN = 2, FUN = function(x) quantile(x, 0.75))

quantile_res_75_quantile_bias <- (quantile_res_75_quantile-quantile(true_reserve, 0.75))/quantile(true_reserve, 0.75)


boxplot(quantile_res_75_quantile_bias, main = "Distribution of relative reserve bias at the 75th quantile")
